...
parser.add_argument('--ckpt', type=str, default='D:/ucsd/SRIP/BLO-SAM-master/SAM/checkpoints/sam_vit_b_01ec64.pth', help='Pretrained checkpoint')
...
if __name__ == "__main__":
    ...
    # for name, param in net.named_parameters():#debug
